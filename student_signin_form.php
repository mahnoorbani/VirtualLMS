			...
			<h3 class="form-signin-heading"><i class="icon-lock"></i> Sign in as Student</h3>
			...
			jQuery("#signin_student").submit(function(e){
					...
					$.ajax({
						...
						if(html=='true')
						{
						$.jGrowl("Welcome to Virtual Academy Learning Management System", { header: 'Sign up Success' });
						var delay = 2000;
